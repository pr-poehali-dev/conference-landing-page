          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center">
              <h1 className="text-xl font-bold text-gray-900">
                <span className="text-primary">УПРАВЛЯЙ</span> / <span className="text-secondary">ВДОХНОВЛЯЙ</span> / <span className="text-primary">МОТИВИРУЙ</span>
              </h1>
            </div>
              ...
              <Card className="p-8 hover:shadow-2xl transition-all duration-300 rounded-3xl border-0 bg-gradient-to-r from-white to-gray-50 hover:scale-105">
                <div className="flex flex-col md:flex-row md:items-center gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-semibold mb-2">Стратегическое мышление лидера</h3>
                    <p className="text-gray-600">Как развивать долгосрочное видение и принимать стратегические решения</p>
                  </div>
                </div>
              </Card>
              <Card className="p-8 hover:shadow-2xl transition-all duration-300 rounded-3xl border-0 bg-gradient-to-r from-white to-gray-50 hover:scale-105">
                <div className="flex flex-col md:flex-row md:items-center gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-semibold mb-2">Мотивация команды в кризис</h3>
                    <p className="text-gray-600">Практические инструменты поддержания мотивации в сложные времена</p>
                  </div>
                </div>
              </Card>
              <Card className="p-8 hover:shadow-2xl transition-all duration-300 rounded-3xl border-0 bg-gradient-to-r from-white to-gray-50 hover:scale-105">
                <div className="flex flex-col md:flex-row md:items-center gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-semibold mb-2">Управление сообществами</h3>
                    <p className="text-gray-600">От идеи до активного сообщества: пошаговый план развития</p>
                  </div>
                </div>
              </Card>
              <Card className="p-8 hover:shadow-2xl transition-all duration-300 rounded-3xl border-0 bg-gradient-to-r from-white to-gray-50 hover:scale-105">
                <div className="flex flex-col md:flex-row md:items-center gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-semibold mb-2">Панельная дискуссия</h3>
                    <p className="text-gray-600">Будущее лидерства: тренды и вызовы следующего десятилетия</p>
                  </div>
                </div>
              </Card>
            </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="text-center overflow-hidden hover:shadow-2xl transition-all duration-300 rounded-3xl bg-gradient-to-br from-white to-gray-50 hover:scale-105 border-0">
              ...
              <CardContent className="p-6">
                ...
                <p className="text-secondary font-medium mb-2">CEO TechCorp</p>
                <p className="text-gray-600 text-sm">15+ лет опыта в управлении IT-компаниями. Эксперт по цифровой трансформации</p>
              </CardContent>
            </Card>
            <Card className="text-center overflow-hidden hover:shadow-2xl transition-all duration-300 rounded-3xl bg-gradient-to-br from-white to-gray-50 hover:scale-105 border-0">
              ...
              <CardContent className="p-6">
                ...
                <p className="text-secondary font-medium mb-2">HR Director</p>
                <p className="text-gray-600 text-sm">Специалист по организационной психологии и мотивации персонала</p>
              </CardContent>
            </Card>
            <Card className="text-center overflow-hidden hover:shadow-2xl transition-all duration-300 rounded-3xl bg-gradient-to-br from-white to-gray-50 hover:scale-105 border-0">
              <div className="aspect-square overflow-hidden bg-gray-100 flex items-center justify-center">
              ...
              <CardContent className="p-6">
                ...
                <p className="text-secondary font-medium mb-2">Community Lead</p>
                <p className="text-gray-600 text-sm">Создатель крупнейших профессиональных сообществ в России</p>
              </CardContent>
            </Card>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto">
            ...
            <Card className="p-10 shadow-2xl rounded-3xl border-0 bg-gradient-to-br from-white via-gray-50 to-white">
              <form className="space-y-6" onSubmit={(e) => { e.preventDefault(); alert('Спасибо за регистрацию! Мы свяжемся с вами в ближайшее время.'); }}>
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">Имя</label>
                    <Input placeholder="Ваше имя" className="w-full" required />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">Фамилия</label>
                    <Input placeholder="Ваша фамилия" className="w-full" required />
                  </div>
                </div>
                <div>
                ...
                <Button type="submit" className="w-full bg-gradient-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary/70 text-white py-4 text-lg rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105">
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <span>Дата: 25 октября 2024</span>
                  </div>
                  <div className="flex items-center gap-3">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span>Место: Конгресс-центр "Экспо"</span>
                  </div>
                  <div className="flex items-center gap-3">
